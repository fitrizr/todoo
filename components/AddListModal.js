        ...
        return (
            ...
            <KeyboardAvoidingView style={styles.container} behavior="padding">
                <TouchableOpacity style={{position: "absolute", top:64, right:32 }} onPress={this.props.closeModal}>
                    <AntDesign name="close" size={40} color={colors.blank} />
                </TouchableOpacity>

                <View style={{ alignSelf: "stretch", marginHorizontal: 32}}>
                    <Text style={styles.title}>Create New Todoo List</Text>
                    <TextInput
                        style={styles.input}
                        placeholder="testing"
                    ...
                    >
                        <Text style={{ color: colors.white, fontWeight: "600" }}>createee</Text>
                    </TouchableOpacity>
